...
function Head({head, setHead}) {
    ...
    return(
        ...
        {head && (<>
        <button className="close-head a mt-5" onClick={() => {moveHeadUp()}}>↑</button>
        <button className="close-head b mt-5" onClick={() => {moveHeadUp()}}>↑</button>
        </>)}
        {!head && (<>
        <button className="close-head a mt-5" onClick={() => {moveHeadDown()}}>↓</button>
        <button className="close-head b mt-5" onClick={() => {moveHeadDown()}}>↓</button>
        </>)}
        </>
    )
}
